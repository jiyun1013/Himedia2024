...
base_options = python.BaseOptions(model_asset_path='models\efficientdet_lite0.tflite')  # 모델 다운받아서 넣은 위치
...
# STEP 5: Process the detection result. In this case, visualize it.  ※ 사람에게 보여주기 위한 영역
